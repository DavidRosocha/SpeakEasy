...
public class GreenButton extends AppCompatActivity {
    ...
    private static final String TAG = "GreenButtonActivity"; // Tag for logs
    private static final String PREFS_NAME = "GreenButtonPrefs";
    private static final String KEY_SAVED_TEXT = "savedText";
    private static final String KEY_SAVED_WAV_PATH = "savedWavPath";

    private EditText editTextTextFour4;
    private TextView textViewTwo2;
    private SharedPreferences sharedPreferences;
    private TextToSpeech textToSpeech;
    private String savedWavPath;

    private static final String WAV_FILE_NAME = "3.wav";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Initializing GreenButton Activity");

        // Initialize SharedPreferences
        sharedPreferences = getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
        editTextTextFour4 = findViewById(R.id.editTextTextFour4);
        textViewTwo2 = findViewById(R.id.textViewTwo2);
        ...
        String savedText = sharedPreferences.getString(KEY_SAVED_TEXT, "Bathroom, please.");
        textViewTwo2.setText(savedText);
    ...
    public void updateTextView(View view) {
        ...
        String newText = editTextTextFour4.getText().toString();
        ...
        new Thread(() -> {
            try {
                ...
                try (OutputStream outputStream = connection.getOutputStream();
                    ...
                    outputStream.write(("Content-Disposition: form-data; name=\"file\"; filename=\"3.wav\"\r\n").getBytes());
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    runOnUiThread(() -> Toast.makeText(GreenButton.this, "File uploaded successfully", Toast.LENGTH_SHORT).show());
                } else {
                    runOnUiThread(() -> Toast.makeText(GreenButton.this, "Upload failed: " + responseCode, Toast.LENGTH_SHORT).show());
                }
            } catch (Exception e) {
                Log.e(TAG, "Upload error", e);
                runOnUiThread(() -> Toast.makeText(GreenButton.this, "Upload error", Toast.LENGTH_SHORT).show());
            }
        }).start();
    }
