...
public class RedButton extends AppCompatActivity {
    ...
    private static final String TAG = "RedButtonActivity"; // Tag for logs
    private static final String PREFS_NAME = "RedButtonPrefs";
    ...
    private static final String WAV_FILE_NAME = "output.wav";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Additional fullscreen flag
        Log.d(TAG, "Initializing RedButton Activity");
        ...
        String savedText = sharedPreferences.getString(KEY_SAVED_TEXT, "Hungry, food please.");
    ...
    // Save the new prompt and generate a WAV file
    public void updateTextView(View view) {
        // Get the input text from the EditText
        String newText = editTextText.getText().toString();
    ...
    public void playMP3(View view) {
        ...
        try {
            ...
            // Optional: Handle playback completion
        ...
        new Thread(() -> {
            try {
                ...
                try (OutputStream outputStream = connection.getOutputStream();
                    ...
                    outputStream.write(("Content-Disposition: form-data; name=\"file\"; filename=\"1.wav\"\r\n").getBytes());
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    runOnUiThread(() -> Toast.makeText(RedButton.this, "File uploaded successfully", Toast.LENGTH_SHORT).show());
                } else {
                    runOnUiThread(() -> Toast.makeText(RedButton.this, "Upload failed: " + responseCode, Toast.LENGTH_SHORT).show());
                }
            } catch (Exception e) {
                Log.e(TAG, "Upload error", e);
                runOnUiThread(() -> Toast.makeText(RedButton.this, "Upload error", Toast.LENGTH_SHORT).show());
            }
        }).start();
    }
