...
public class YellowButton extends AppCompatActivity {
    ...
    private static final String TAG = "YellowButtonActivity"; // Tag for logs
    private static final String PREFS_NAME = "YellowButtonPrefs";
    private static final String KEY_SAVED_TEXT = "savedText";
    private static final String KEY_SAVED_WAV_PATH = "savedWavPath";

    private EditText editTextTextFourFour;
    private TextView textViewTwoTwo;
    private SharedPreferences sharedPreferences;
    private TextToSpeech textToSpeech;
    private String savedWavPath;

    private static final String WAV_FILE_NAME = "4.wav";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Initializing YellowButton Activity");

        // Initialize SharedPreferences
        sharedPreferences = getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
        editTextTextFourFour = findViewById(R.id.editTextTextFourFour);
        textViewTwoTwo = findViewById(R.id.textViewTwoTwo);
        ...
        String savedText = sharedPreferences.getString(KEY_SAVED_TEXT, "Change TV Channel please.");
        textViewTwoTwo.setText(savedText);
    ...
    public void updateTextView(View view) {
        ...
        String newText = editTextTextFourFour.getText().toString();
        ...
        // Update the TextView
        textViewTwoTwo.setText(newText);
        ...
        new Thread(() -> {
            try {
                ...
                try (OutputStream outputStream = connection.getOutputStream();
                    ...
                    outputStream.write(("Content-Disposition: form-data; name=\"file\"; filename=\"4.wav\"\r\n").getBytes());
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    runOnUiThread(() -> Toast.makeText(YellowButton.this, "File uploaded successfully", Toast.LENGTH_SHORT).show());
                } else {
                    runOnUiThread(() -> Toast.makeText(YellowButton.this, "Upload failed: " + responseCode, Toast.LENGTH_SHORT).show());
                }
            } catch (Exception e) {
                Log.e(TAG, "Upload error", e);
                runOnUiThread(() -> Toast.makeText(YellowButton.this, "Upload error", Toast.LENGTH_SHORT).show());
            }
        }).start();
    }
